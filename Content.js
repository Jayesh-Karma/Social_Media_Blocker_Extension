...
const img = 'https://hoor72.com/assets/padhai-likhai-karo-meme.png'
const html= (tagname) => {
    return `<div>
    ...
    <div class="main">
      ...
      <div class="tv">
        ...
        <div class="display_div">
         <img class="screen_out1" src=${img} alt="">
        </div>
        <div class="lines">
          <div class="line1"></div>
          <div class="line2"></div>
    ...
    <div class="text_404">
      <h1>Focus on Goal 🎯</h1>
      <p class="text_">Studies >>>> ${tagname}</p>
    </div>
  </div>
`
}

const cssStyles = () => { return `
...
switch(document.location.hostname){
    ...
    document.head.innerHTML = cssStyles();    
    document.body.innerHTML = html("Youtube", "./display_meme.webp");
        break;
